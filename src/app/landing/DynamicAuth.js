...
export default function DynamicAuth ({...props}) {
	...
	return (
  	<BoxBackground sx={{py: '10rem', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
  		...
  		<Tooltip title={<Typography>Welcome to betblock! We are glad you are here. When you connect for the first time, you will be prompted to submit maximum of 3 words, which will be used to generate your unique NFT & profile.</Typography>}>
